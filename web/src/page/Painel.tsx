...
import PermissoesUsuarios from "./permissoes-usuarios";
import ArmarioVirtual from "./armario-virtual";
...
const Painel: React.FC = () => {
  ...
  if (loaderState.show)
    return (
      <div className="fixed inset-0 bg-white flex items-center justify-center p-2 sm:p-4 z-[8000]">
